...
*This Reporting module is the report-generation sub-domain. Maintained alongside `docs/modules/Analytics-Reporting.md` (parent — analytics-engine + dashboards) and consistent with the v2.0.0 foundation.*
