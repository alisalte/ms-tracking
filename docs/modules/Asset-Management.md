...
*This Asset Management module supersedes `docs/modules/Asset-Lifecycle.md` (v1.0.0, vehicle-depreciation-only) and owns the Asset Lifecycle bounded context. Consistent with the v2.0.0 foundation.*
