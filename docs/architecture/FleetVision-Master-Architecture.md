...
| Document | Location |
|---|---|
| Domain Model Specification | `/docs/architecture/FleetVision-Domain-Model.md` |
| Bounded Context Specifications | `/docs/modules/` (per context) |
| Architecture Decision Records | `/docs/adr/ADR-*.md` |
| API Specifications | `/API/` |
| Database Schema | `/Database/` |
| Security Threat Model | `/docs/security/FleetVision-Threat-Model.md` |
