...
export const GEOFENCE_DEFINITIONS_REPOSITORY = 'GEOFENCE_DEFINITIONS_REPOSITORY';
export const GEOFENCE_STATE_REPOSITORY = 'GEOFENCE_STATE_REPOSITORY';
export const GEOFENCE_EVALUATOR = 'GEOFENCE_EVALUATOR';
