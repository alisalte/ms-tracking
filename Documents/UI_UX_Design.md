...
This document is the **canonical UI/UX reference** for FleetVision's user-facing surfaces. It translates the platform's product vision (`00_Project_Vision.md`) and module capabilities (`Modules/*.md`) into concrete screens, flows, and interaction patterns for the people who operate fleets every day.
...
The **video operations surface** — live view, playback, AI event review, and the fleet video wall. See `Modules/VideoPlatform.md` for the underlying platform.
...
The **maintenance operations surface** for fleet managers and shop managers — planned and corrective work, parts, and vehicle health. See `Modules/Vehicle-Maintenance.md`.
...
The **configuration surface** for tenant admins — users, fleets, policies, devices, integrations, billing, SSO. See `Modules/Authentication.md` (users/SSO), `Modules/Telemetry-Device-Management.md` (devices), `Modules/Billing-Tenant-Management.md` (billing).
...
The **driver app** (React Native, iOS + Android) — the in-cab companion. See driver persona; HOS/DVIR/Trip from `Modules/Compliance-Safety.md`, `Modules/Trip-Route-Management.md`.
...
```
(See `Modules/Authentication.md` §13 for screen wireframes.)
...
✅ full · ◐ scoped · ro read-only · — no access. Permissions enforced per `Modules/Authentication.md` §11 RBAC.
...
| `Modules/Authentication.md` (RBAC, MFA, SSO) | §5, §7.1, §7.8, Appendix A |
| `Modules/Tracking-Monitoring.md` (map, geofences) | §2 |
| `Modules/GPSEngine.md` (trip/stop/idle, behavior, replay) | §1.4, §2.5, §7.6 |
| `Modules/VideoPlatform.md` (live/playback/wall/AI) | §3, §7.5, §8.9 |
| `Modules/Vehicle-Maintenance.md` (WO/PM/parts/DTC) | §4, §7.4 |
| `Modules/Compliance-Safety.md` (HOS, DVIR, incidents) | §6.6, §7.6, §8.12 |
| `Modules/Trip-Route-Management.md` (dispatch, POD) | §7.3, §6.7 |
| `Modules/Billing-Tenant-Management.md` (tiers, usage) | §5.4 (Billing) |
